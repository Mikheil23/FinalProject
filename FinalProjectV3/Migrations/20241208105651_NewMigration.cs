    ...
    public partial class NewMigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AccountantCredentials", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AccountantCredentialsId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Accountants", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Accountants_AccountantCredentials_AccountantCredentialsId",
                        column: x => x.AccountantCredentialsId,
                        principalTable: "AccountantCredentials",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Accountants_AccountantCredentialsId",
                table: "Accountants",
                column: "AccountantCredentialsId",
                unique: true,
                filter: "[AccountantCredentialsId] IS NOT NULL");
